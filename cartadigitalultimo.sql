...
-- Volcando datos para la tabla carta_digital.pedidos: ~55 rows (aproximadamente)
...
-- Volcando datos para la tabla carta_digital.pedido_detalle: ~88 rows (aproximadamente)
